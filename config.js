...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "DARK-SILENCE-MD~fI9ElILL#ciP61j-y_FQqQOIEPzsGL8R3YNv6ojkYdAcF9tOifRE",
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "918889252984",
    OWNER_NAME: process.env.OWNER_NAME || "Khushi",
    READ_CMD: process.env.READ_CMD || "true",
    BOT_NAME: process.env.BOT_NAME || "cartoon ladki",
